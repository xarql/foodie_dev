...
public class MyCommentsController extends BaseController {
    ...
    @ApiOperation(value="查询评论",notes="查询评论",httpMethod = "POST")
    @PostMapping("/pending")
    public IMOOCJSONResult pending(
        ...
        //判断该笔订单是否已经评价过，评价过后不再评价
        OrderDO myOrder=(OrderDO) checkResult.getData();
        if(myOrder.getIsComment()== YesOrNo.YES.type){
            return IMOOCJSONResult.errorMsg("该笔订单已经评价");
        }

        List<OrderItemsDO> list=myCommentsService.queryPendingComment(orderId);
